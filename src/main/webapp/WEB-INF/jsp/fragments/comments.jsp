...
<c:forEach items="${requestScope.comments}" var="comment">
    <div class="media-object comment-item" data-id-comment="${comment.id}">
        <div class="media-object-section">
            <img src="${comment.account.avatarExists ? comment.account.urlAvatar : comment.account.defaultUrlAvatar}"
        ...
        <div class="media-object-section">
            ...
            <p>${comment.content}</p>
            <p class="meta">
                <small><fmt:formatDate type="both" value="${comment.dateOfCreated}" dateStyle="MEDIUM" timeStyle="SHORT"/></small> |
