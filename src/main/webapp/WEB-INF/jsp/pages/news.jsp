...
<div class="article thumbnail">
    <a href="<c:url value="/article"/>"><img src="http://placehold.it/1000x400"
                                             alt="Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem."></a>
    <div class="data">
        <h3>
            <a href="<c:url value="/article"/>">Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem.</a>
        </h3>
...
<div class="article thumbnail">
    <a href="<c:url
            value="/article"/>"><img src="http://placehold.it/1000x400" alt="Donec venenatis vulputate lorem."></a>
    <div class="data">
        <h3><a href="<c:url value="/article"/> ">Donec venenatis vulputate lorem.</a></h3>
        <ul class="vertical large-horizontal menu">
